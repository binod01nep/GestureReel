globalThis.createMediapipeSolutionsPackedAssetsLoader = function(customModule) {
  var Module = customModule || (typeof createMediapipeSolutionsPackedAssets !== 'undefined' ? createMediapipeSolutionsPackedAssets : {});
  ...
  (function() {
    ...
    var loadPackage = function(metadata) {
      ...
      var EXTENSION_SCRIPT_URL = typeof document !== 'undefined' && document.currentScript ? document.currentScript.src : '';
      if (!Module['locateFile'] && EXTENSION_SCRIPT_URL) {
        Module['locateFile'] = function(file) { return new URL(file, EXTENSION_SCRIPT_URL).href; };
      }
      if (typeof Module['locateFilePackage'] === 'function' && !Module['locateFile']) {
        Module['locateFile'] = Module['locateFilePackage'];
        err('warning: you defined Module.locateFilePackage, that has been renamed to Module.locateFile (using your locateFilePackage for now)');
      }
      var REMOTE_PACKAGE_NAME = Module['locateFile'] ? Module['locateFile'](REMOTE_PACKAGE_BASE, '') : (typeof document !== 'undefined' && document.currentScript && document.currentScript.src ? new URL(REMOTE_PACKAGE_BASE, document.currentScript.src).href : REMOTE_PACKAGE_BASE);
